...
for (let i = 0; i < navigationLinks.length; i++) {
  navigationLinks[i].addEventListener("click", function () {
    ...
    const clickedLink = this; // referência do botão clicado
    const targetPage = clickedLink.innerHTML.trim().toLowerCase();
    ...
    // Ativa apenas o link e a página correspondente
